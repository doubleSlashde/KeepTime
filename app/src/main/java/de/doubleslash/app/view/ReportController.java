...
import de.doubleslash.app.view.worktable.ProjectTableRow;
import de.doubleslash.app.view.worktable.TableRow;
import de.doubleslash.app.view.worktable.WorkTableRow;
...
import de.doubleslash.app.common.Resources;
import de.doubleslash.app.common.Resources.RESOURCE;
import de.doubleslash.app.common.SvgNodeProvider;
import de.doubleslash.app.controller.Controller;
import de.doubleslash.app.exceptions.FXMLLoaderException;
import de.doubleslash.app.model.Model;
import de.doubleslash.app.model.Work;
...
public class ReportController {
   ...
   @FXML
   private TreeTableView<de.doubleslash.app.view.worktable.TableRow> workTableTreeView;
   ...
   private final TreeItem<de.doubleslash.app.view.worktable.TableRow> rootItem = new TreeItem<>();
   ...
   private void initTableView() {
      final TreeTableColumn<de.doubleslash.app.view.worktable.TableRow, de.doubleslash.app.view.worktable.TableRow> noteColumn = new TreeTableColumn<>("Notes");
      noteColumn.setCellFactory(new Callback<TreeTableColumn<de.doubleslash.app.view.worktable.TableRow, de.doubleslash.app.view.worktable.TableRow>, TreeTableCell<de.doubleslash.app.view.worktable.TableRow, de.doubleslash.app.view.worktable.TableRow>>() {
         @Override
         public TreeTableCell<de.doubleslash.app.view.worktable.TableRow, de.doubleslash.app.view.worktable.TableRow> call(final TreeTableColumn<de.doubleslash.app.view.worktable.TableRow, de.doubleslash.app.view.worktable.TableRow> column) {
            return new TreeTableCell<de.doubleslash.app.view.worktable.TableRow, de.doubleslash.app.view.worktable.TableRow>() {
               @Override
               protected void updateItem(final de.doubleslash.app.view.worktable.TableRow item, final boolean empty) {
      ...
      noteColumn.setCellValueFactory(
            (final TreeTableColumn.CellDataFeatures<de.doubleslash.app.view.worktable.TableRow, de.doubleslash.app.view.worktable.TableRow> entry) -> new ReadOnlyObjectWrapper<>(
                  entry.getValue().getValue()));
      noteColumn.setMinWidth(200);
      noteColumn.setReorderable(false);
      this.workTableTreeView.getColumns().add(noteColumn);

      final TreeTableColumn<de.doubleslash.app.view.worktable.TableRow, String> timeRangeColumn = new TreeTableColumn<>("Timeslot");
      timeRangeColumn.setCellValueFactory(new TreeItemPropertyValueFactory<de.doubleslash.app.view.worktable.TableRow, String>("timeRange"));
      timeRangeColumn.setMinWidth(120);
      timeRangeColumn.setReorderable(false);
      this.workTableTreeView.getColumns().add(timeRangeColumn);

      final TreeTableColumn<de.doubleslash.app.view.worktable.TableRow, de.doubleslash.app.view.worktable.TableRow> timeSumColumn = new TreeTableColumn<>("Duration");
      timeSumColumn.setCellFactory(new Callback<>() {
         @Override
         public TreeTableCell<de.doubleslash.app.view.worktable.TableRow, de.doubleslash.app.view.worktable.TableRow> call(
               TreeTableColumn<de.doubleslash.app.view.worktable.TableRow, de.doubleslash.app.view.worktable.TableRow> tableRowStringTreeTableColumn) {

            return new TreeTableCell<>() {

               @Override
               protected void updateItem(de.doubleslash.app.view.worktable.TableRow workItem, boolean empty) {
      ...
      final TreeTableColumn<de.doubleslash.app.view.worktable.TableRow, Button> buttonColumn = new TreeTableColumn<>("Controls");
      buttonColumn.setCellValueFactory(new TreeItemPropertyValueFactory<de.doubleslash.app.view.worktable.TableRow, Button>("buttonBox"));
   ...
   private void updateReport(final LocalDate dateToShow) {
      ...
      for (final Project project : workedProjectsSet) {
         ...
         final TreeItem<de.doubleslash.app.view.worktable.TableRow> projectRow = new TreeItem<>(
